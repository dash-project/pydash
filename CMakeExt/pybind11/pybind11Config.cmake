...
#   pybind11::embedded - for embedding the Python interpreter
#
...
#   target_link_libraries(myexe pybind11::embedded)
#
# Suggested usage::
#
...
if(NOT TARGET ${PN}::pybind11)
    ...
    set_property(TARGET ${PN}::embedded APPEND PROPERTY INTERFACE_LINK_LIBRARIES ${PYTHON_LIBRARIES})
    if(WIN32 OR CYGWIN)
